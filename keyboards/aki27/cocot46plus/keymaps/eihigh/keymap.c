...
#define LT1_SPC LT(_LAYER_SYMNUM, KC_SPC)
#define LT2_SPC LT(_LAYER_CTRL, KC_SPC)
#define MO_TRKB MO(_LAYER_TRACKBALL)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|-------------------------------------------------------|                                   |-------------------------------------------------------|
                        MO_TRKB, KC_LSFT, LT2_SPC,  KC_LGUI, KC_MS_BTN1,              KC_MS_BTN2,  KC_RCTL, LT1_SPC, KC_RSFT, KC_RALT,  
                                                                 KC_PGUP, KC_MS_BTN3,    KC_PGDN,  XXXXXXX, XXXXXXX, XXXXXXX
                                                            //`--------------'  `--------------'
    ),
  [_LAYER_SHINGETA] = LAYOUT(
  //|-------------------------------------------------------|                                   |-------------------------------------------------------|
         JP_Q, JP_SLSH,   JP_NI,   JP_HA, JP_COMM,    JP_TI,                                         JP_GU,   JP_TE,   JP_KO,   JP_GA,   JP_HI,   JP_GE,
  //|-------------------------------------------------------|                                   |-------------------------------------------------------|
      JP_EXLM,   JP_NO,   JP_TO,   JP_KA,   JP_NN,   JP_XTU,                                         JP_KU,    JP_U,    JP_I,   JP_SI,   JP_NA, KC_BSPC,
  //|-------------------------------------------------------|                                   |-------------------------------------------------------|
         JP_X,   JP_SU,   JP_MA,   JP_KI,   JP_RU,    JP_TU,                                         JP_BA,   JP_TA,   JP_DE,  JP_DOT,   JP_BU, _______,
  //|-------------------------------------------------------|                                   |-------------------------------------------------------|
  ...
  //|-------------------------------------------------------|                                   |-------------------------------------------------------|
      MACRO2,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,                                           KC_0,     KC_1,    KC_2,    KC_3,    KC_4, _______,
  //|-------------------------------------------------------|                                   |-------------------------------------------------------|
                        _______, _______, _______,  _______,   KC_MS_BTN4,             KC_MS_BTN5, _______, _______, _______, _______,
                                                                 KC_PGUP, KC_MS_BTN3,    KC_PGDN, XXXXXXX, XXXXXXX, XXXXXXX
                                                            //`--------------'  `--------------'
  ...
  [_LAYER_CTRL] = LAYOUT(
  //|-------------------------------------------------------|                                   |-------------------------------------------------------|
     _______, A(KC_ENT), C(KC_ENT), G(KC_ENT), S(KC_ENT), _______,                                 _______, KC_HOME,   KC_UP,  KC_END, _______, _______,
  //|-------------------------------------------------------|                                   |-------------------------------------------------------|
     _______, ESCIMOFF,  KC_TAB,  KC_ENT,   IMOFF,  _______,                                          IMON, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______,
  //|-------------------------------------------------------|                                   |-------------------------------------------------------|
