...
#define CLOSTAB G(KC_W)
#define NEWTAB  G(KC_T)
#define NAVBACK G(KC_LEFT)
#define NAVFORW G(KC_RGHT)
#define MISSCTL C(KC_UP)

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [LAYER_BASE] = LAYOUT(
  //|-------------------------------------------------------|                                   |-------------------------------------------------------|
         KC_Q,    KC_Y,    KC_P,    KC_O,    KC_U,     KC_J,                                         KC_K,    KC_D,    KC_L,    KC_C,    KC_W,    KC_Z,
  //|-------------------------------------------------------|                                   |-------------------------------------------------------|
      KC_QUOT,    KC_I,    KC_N,    KC_E,    KC_A,  KC_COMM,                                         KC_M,    KC_H,    KC_T,    KC_S,    KC_R, KC_BSPC,
  //|-------------------------------------------------------|                                   |-------------------------------------------------------|
      KC_PERC, KC_SLSH, KC_EXLM, KC_BSLS,  KC_DOT,  KC_SCLN,                                         KC_B,    KC_F,    KC_G,    KC_V,    KC_X,  KC_GRV,
  //|-------------------------------------------------------|                                   |-------------------------------------------------------|
                        _______, KC_LSFT, LT3_SPC,   LCLICK, KC_LCTL,                    KC_RGUI,  LT4_RC, LT2_SPC, MO(LAYER_OTHERS), KC_RALT,  
  ...
  //|-------------------------------------------------------|                                   |-------------------------------------------------------|
      JP_SLSH, JP_EXLM,   JP_NI,   JP_HA, JP_COMM,    JP_TI,                                        JP_GU,   JP_TE,   JP_KO,   JP_GA,   JP_HI,   JP_GE,
  //|-------------------------------------------------------|                                   |-------------------------------------------------------|
      JP_MINS,   JP_NO,   JP_TO,   JP_KA,   JP_NN,   JP_XTU,                                        JP_KU,    JP_U,    JP_I,   JP_SI,   JP_NA, KC_BSPC,
  //|-------------------------------------------------------|                                   |-------------------------------------------------------|
         JP_X,   JP_SU,   JP_MA,   JP_KI,   JP_RU,    JP_TU,                                        JP_BA,   JP_TA,   JP_DE,  JP_DOT,   JP_BU,   JP_VU,
  //|-------------------------------------------------------|                                   |-------------------------------------------------------|
  ...
  [LAYER_SYMNUM] = LAYOUT(
  //|-------------------------------------------------------|                                   |-------------------------------------------------------|
      MACRO1,  KC_PIPE, KC_LBRC, KC_RBRC,  KC_DLR,  KC_PLUS,                                      KC_HASH,  KC_DQUO, KC_LABK, KC_RABK, KC_CIRC,   KC_AT,
  //|-------------------------------------------------------|                                   |-------------------------------------------------------|
     KC_QUES,  KC_AMPR, KC_LCBR, KC_RCBR,  KC_MINS, KC_COLN,                                      KC_ASTR,  KC_UNDS, KC_LPRN, KC_RPRN,  KC_EQL, _______,
  //|-------------------------------------------------------|                                   |-------------------------------------------------------|
      MACRO2,     KC_9,    KC_8,    KC_7,     KC_6,    KC_5,                                         KC_0,     KC_1,    KC_2,    KC_3,    KC_4, _______,
  //|-------------------------------------------------------|                                   |-------------------------------------------------------|
                        _______, _______, _______,  _______, _______,                    _______, _______, _______, _______, _______,
                                                             XXXXXXX,     _______,       XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
                                                            //`--------------'  `--------------'
  ...
  [LAYER_CTRL] = LAYOUT(
  //|-------------------------------------------------------|                                   |-------------------------------------------------------|
      _______, OS_LSFT, OS_LCTL, OS_LGUI, OS_LALT, _______,                                       _______, KC_HOME,   KC_UP,  KC_END, _______, _______,
  //|-------------------------------------------------------|                                   |-------------------------------------------------------|
      _______, ESCEISU,  KC_TAB,  KC_ENT,    KANA, _______,                                       _______, KC_LEFT, KC_DOWN, KC_RGHT,    EISU, _______,
  //|-------------------------------------------------------|                                   |-------------------------------------------------------|
  ...
  [LAYER_GUI] = LAYOUT(
  //|-------------------------------------------------------|                                   |-------------------------------------------------------|
      _______, KC_HOME, NAVBACK, NAVFORW,  KC_END, _______,                                       _______, MS_WHLU,   MS_UP, MS_WHLD, _______, _______,
  //|-------------------------------------------------------|                                   |-------------------------------------------------------|
      _______, CLOSTAB, PREVTAB, NEXTTAB,  NEWTAB, MISSCTL,                                       MS_BTN2, MS_LEFT, MS_DOWN, MS_RGHT, MS_BTN1, _______,
  //|-------------------------------------------------------|                                   |-------------------------------------------------------|
      _______, G(KC_Z), G(KC_X), G(KC_C), G(KC_V), _______,                                       _______, _______, _______, _______, _______, _______,
  //|-------------------------------------------------------|                                   |-------------------------------------------------------|
                        _______, _______, _______,  _______, _______,                    _______, _______, _______, _______, _______,
  ...
  [LAYER_OTHERS] = LAYOUT(
  //|-------------------------------------------------------|                                   |-------------------------------------------------------|
      _______,   KC_F1,   KC_F2,   KC_F3,   KC_F4,  _______,                                      _______, RGB_TOG, SCRL_IN, _______, _______, _______,
  //|-------------------------------------------------------|                                   |-------------------------------------------------------|
      _______,   KC_F5,   KC_F6,   KC_F7,   KC_F8,  _______,                                      _______, KC_MPRV, KC_MPLY, KC_MNXT, _______, _______,
  //|-------------------------------------------------------|                                   |-------------------------------------------------------|
  ...
  //|-------------------------------------------------------|                                   |-------------------------------------------------------|
    ...
    [LAYER_SHIFT] = LAYOUT(
  //|-------------------------------------------------------|                                   |-------------------------------------------------------|
     S(KC_Q), S(KC_Y), S(KC_P), S(KC_O), S(KC_U), S(KC_J),                                        S(KC_K), S(KC_D), S(KC_L), S(KC_C), S(KC_W), S(KC_Z),
  //|-------------------------------------------------------|                                   |-------------------------------------------------------|
     KC_QUOT, S(KC_I), S(KC_N), S(KC_E), S(KC_A), KC_COMM,                                        S(KC_M), S(KC_H), S(KC_T), S(KC_S), S(KC_R), KC_BSPC,
  //|-------------------------------------------------------|                                   |-------------------------------------------------------|
     KC_PERC, KC_SLSH, KC_EXLM, KC_BSLS,  KC_DOT, KC_SCLN,                                        S(KC_B), S(KC_F), S(KC_G), S(KC_V), S(KC_X),  KC_GRV,
  //|-------------------------------------------------------|                                   |-------------------------------------------------------|
                        _______, _______, _______,  _______, _______,                    _______, _______, _______, _______, _______,
                                                             XXXXXXX,     _______,       XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
                                                            //`--------------'  `--------------'
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    [LAYER_BASE]     = { ENCODER_CCW_CW(S(KC_TAB), KC_TAB) },
    [LAYER_SHINGETA] = { ENCODER_CCW_CW(S(KC_TAB), KC_TAB) },
    [LAYER_SYMNUM]   = { ENCODER_CCW_CW(S(KC_TAB), KC_TAB) },
    [LAYER_CTRL]     = { ENCODER_CCW_CW(S(KC_TAB), KC_TAB) },
    [LAYER_GUI]      = { ENCODER_CCW_CW(KC_VOLU, KC_VOLD) },
    [LAYER_OTHERS]   = { ENCODER_CCW_CW(S(KC_TAB), KC_TAB) },
